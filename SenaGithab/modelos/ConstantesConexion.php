...
define("BASE", "digiteachbox2"); //se define una constante para la base, de ahora en adelante BASE
...
//constante
define("PATH",$_SERVER['DOCUMENT_ROOT']."/"."ProyectoSena"."/");


/*Si se van a utilizar imagenes propias del proyecto es recomendable crear constantes a la ruta
